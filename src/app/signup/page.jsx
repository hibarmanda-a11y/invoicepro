...
import { FileText, ArrowRight, Eye, EyeOff, ShieldCheck, Sparkles, Check } from "lucide-react";
          ...
          <div>
            ...
            <div className="mt-12">
              ...
              <h2 className="text-2xl font-semibold tracking-tight text-white leading-snug">
                Everything you need to craft professional invoices.
              </h2>
              
              <ul className="mt-6 space-y-2.5 text-xs text-white/70">
                <li className="flex items-center gap-2">
                  <Check size={14} className="text-emerald-400" /> Free access to all curated invoice layouts
                </li>
                <li className="flex items-center gap-2">
                  <Check size={14} className="text-emerald-400" /> High-resolution PDF document exports
                </li>
                <li className="flex items-center gap-2">
                  <Check size={14} className="text-emerald-400" /> Save invoice history to your account
                </li>
              </ul>
            </div>
          </div>
        ...
        <div className="p-8 sm:p-10 flex flex-col justify-center">
          <div>
            ...
            <p className="mt-1 text-xs text-[#777771]">
              Start generating high quality invoices today
            </p>
          </div>
          ...
          <form onSubmit={submit} className="space-y-3.5">
            <div>
              <label className="block text-xs font-semibold text-[#333330] mb-1">
                Full Name
              </label>
              <input
                type="text"
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    placeholder="••••••••"
                    className="saas-input pr-9"
                  />
                  <button
                    type="button"
                    onClick={() => setShowPassword(!showPassword)}
                    className="absolute right-2.5 top-1/2 -translate-y-1/2 text-[#9a9a94] hover:text-[#141413]"
                  >
          ...
          <p className="mt-5 text-center text-xs text-[#777771]">
