...
export default function TemplatesShowcase() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-10">
      ...
      {/* View All Templates Button with mouse scroll animation */}
      <div className="flex justify-center mt-12">
        <Link
          href="/templates"
          className="bg-black text-white px-8 py-4 rounded-full font-semibold text-lg hover:bg-gray-800 transition-all duration-300 transform hover:scale-105 active:scale-95"
          >
          View all Templates
        </Link>
      </div>
